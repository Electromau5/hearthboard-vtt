...
export default function EditCharacterPage() {
  ...
  const load = useCallback(async () => {
    ...
    else router.replace("/admin/characters");
  }, [slug, router]);
  ...
  if (!char) return <div style={{ ...page, justifyContent: "center", alignItems: "center", color: "var(--ink-text-2)" }}>Loading…</div>;
    ...
    <div style={page}>
      <div style={topbar}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <Link href="/admin/characters" style={{ color: "var(--ink-text-2)", fontSize: 13, textDecoration: "none" }}>Characters</Link>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <Link href={`/characters/${slug}`} className="btn btn-ghost btn-sm nav-btn">
